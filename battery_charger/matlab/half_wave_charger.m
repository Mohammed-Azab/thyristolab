...
if enablePlots && (isempty(t_charge) || isinf(t_charge))
    figure('Name', 'Half-Wave Rectifier - Firing Angle vs Charging Time', 'Position', [100, 100, 900, 600]);
    
    % Use logarithmic scale for better visualization of large variations
    semilogy(alpha_deg, charging_time_hours, 'b-', 'LineWidth', 2.5, 'MarkerSize', 8, 'Marker', 'o', 'MarkerFaceColor', 'b');
    grid on;
    ...
    title('Half-Wave Controlled Rectifier', 'Interpreter', 'latex', 'FontSize', 18);
...
if enablePlots
    figure('Name', 'Half-Wave Rectifier - Power Losses vs Firing Angle', 'Position', [100, 100, 900, 600]);
