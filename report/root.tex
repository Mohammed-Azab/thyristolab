...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\large Semi-Controlled Rectifiers for Battery Charging\par}
    ...
    \vspace{0.2cm}
    {\large\url{https://github.com/Mohammed-Azab/thyristolab}\par}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/CTSIMULINK.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/bgSimulink.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/hfSimulink.jpeg}
