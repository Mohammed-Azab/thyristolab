...
% Full-wave center-tapped rectifier implementation
% Similar structure to half_wave_charger but with key differences:
% - Uses absolute value of sine wave: V_abs = Vm * abs(sin(theta))
% - Output frequency doubled (100 Hz ripple vs 50 Hz)
% - Average voltage: Vdc = (2*Vm/pi) * (1 + cos(alpha)) - Vt
% - One thyristor drop per conduction path

% Parameter parsing and initialization similar to half_wave_charger
% ... (full implementation with same structure)

% Key difference: Full-wave rectification
...
for k = 1:na
    ...
    % Gate available when theta_mod >= a within each half-cycle
    ...
    % ... (remaining calculations similar to half_wave)
end

% Plotting and output similar to half_wave_charger
end
\end{lstlisting}
