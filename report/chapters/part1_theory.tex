...
% Explain thyristor operation including:
\begin{itemize}
...
% Add figure showing thyristor symbol and V-I characteristics
\begin{figure}[H]
    \centering
...
% Describe half-wave rectifier theory:
...
% Derive the output current equation considering battery EMF and resistance

\subsection{Full-Wave Controlled Rectifier - Center-Tapped}
% Describe center-tapped full-wave rectifier theory:

\subsubsection{Circuit Configuration}
% Add circuit diagram with center-tapped transformer and two SCRs
\begin{figure}[H]
    \centering
    % Circuit diagram
...
% Describe bridge rectifier theory:

\subsubsection{Circuit Configuration}
% Add circuit diagram with 4 SCRs in bridge configuration
\begin{figure}[H]
    \centering
    % Circuit diagram
...
\subsubsection{Mathematical Analysis}
% Note that equations are same as center-tapped but circuit differences:
\begin{itemize}
...
\begin{equation}
    P_{loss} = V_t \cdot I_{avg} + R_{th} \cdot I_{rms}^2
\end{equation}
