...
\toprule
\textbf{Objective} & \textbf{Achieved} & \textbf{Evidence} \\ \midrule
Design battery charger MATLAB functions & ✓ & Section \ref{} \\
Simulate controlled rectifiers in Simulink & ✓ & Section \ref{} \\
Analyze firing angle effects & ✓ & Sections \ref{}, \ref{} \\
Study different load types & ✓ & Section \ref{} \\
Investigate free-wheeling diodes & ✓ & Section \ref{} \\
Compare configurations & ✓ & Sections \ref{}, \ref{} \\
Design firing circuits & ✓ & Section \ref{} \\
Validate with analytical calculations & ✓ & Sections \ref{}, \ref{} \\ \bottomrule
\end{tabular}
\end{table}
