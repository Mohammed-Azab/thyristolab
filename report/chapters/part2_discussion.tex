...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/ResistiveLoadVoltageWithoutDiode.jpeg}
    \caption{Half-wave rectifier output voltage for resistive load without FWD. Discontinuous voltage pulses during positive half-cycles only.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/ResistiveLoadCurrentWithoutDiode.jpeg}
    \caption{Half-wave rectifier output current for resistive load without FWD. Discontinuous current pulses during positive half-cycles only.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/VRWithD.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/17.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/RL.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/RL2.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/VRLwithDiode.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/IRWithD.jpeg}
    \caption{Half-wave rectifier output current for RL load with FWD. Similar to non-FWD case due to absence of stored energy.}
    \label{fig:hf_r_iout_fwd}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/IHIL.jpeg}
    \caption{Half-wave rectifier waveforms for highly inductive load. Nearly constant current due to large time constant; continuous conduction with significant average value.}
    \label{fig:hf_hi_1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/VRND.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/IRND.png}
    \caption{Center-tapped full-wave rectifier output current for thyristor 1 without FWD. Discontinuous current with two pulses per AC cycle.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/VRLND.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/IRLND.png}
    \caption{Center-tapped full-wave rectifier output current for R-L load for thyristor 1 without FWD. More continuous current than half-wave due to doubled pulse frequency.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/VRLWD.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/IRLD.png}
    \caption{Center-tapped full-wave rectifier output current for R-L load for thyristor 1 with FWD. Continuous conduction achieved at moderate firing angles.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/CT/IRL.png}
    \caption{Center-tapped full-wave rectifier for highly inductive load. Nearly constant DC current with excellent continuity and very smooth output with small ripple.}
    \label{fig:ct_hi}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/VRRWithoutD.jpeg}
    \caption{Bridge full-wave rectifier output voltage for resistive load without FWD. Similar to center-tapped but with two thyristor drops in series.}
    \label{fig:bg_r_vout_nofwd}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/IRRWithoutD.jpeg}
    \caption{Bridge full-wave rectifier output current for resistive load without FWD. Discontinuous current with two pulses per AC cycle.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/VRRWithD.jpeg}
    \caption{Bridge full-wave rectifier output voltage for resistive load with FWD. Minimal effect for resistive loads as current naturally goes to zero with voltage.}
    \label{fig:bg_r_vout_fwd}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/IRRWithD.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/VoltageRLnodiode.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/VoltageRLwithdiode.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/IRLwithdiode.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/BG/Highly_inductiveI.jpeg}
    \caption{Bridge full-wave rectifier current for highly inductive load showing nearly constant DC current with minimal ripple.}
    \label{fig:bg_hi}
\end{figure}
