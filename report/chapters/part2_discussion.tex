...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/IHIL2.jpeg}
    \caption{Half-wave rectifier for highly inductive load showing extended conduction period.}
    \label{fig:hf_hi_2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Load_Analysis/HF/IHIL3.jpeg}
    \caption{Half-wave rectifier for highly inductive load with FWD effect. Continuous current maintained with small ripple.}
    \label{fig:hf_hi_3}
\end{figure}
